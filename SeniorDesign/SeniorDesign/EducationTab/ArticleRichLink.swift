...
struct ArticleRichLink: View {
    ...
    var articleContent: AttributedString
    var image: String
    ...
    var body: some View {
        NavigationLink(destination: ArticleView(articleTitle: articleTitle, articleDescription: articleContent, articleDisclaimer: articleDisclaimer, image: image))
        {
